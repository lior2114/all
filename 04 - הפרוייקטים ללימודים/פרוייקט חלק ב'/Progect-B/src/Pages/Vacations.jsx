  ...
  return (
    <Container maxWidth="lg">
      ...
      {loading ? (
        ...
        <Box role="list" sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: 'repeat(2, 1fr)', md: 'repeat(3, 1fr)' }, gap: 3, alignItems: 'stretch' }}>
              ...
              <Box key={vacationId} role="listitem" sx={{ display: 'flex' }}>
                <Card sx={{ display: 'flex', flexDirection: 'column', width: '100%' }}>
                  <Box sx={{ position: 'relative' }}>
                    ...
                    />
                    {/* gradient overlay (stronger in light mode for readability) */}
                    <Box
                      sx={{
                        position: 'absolute',
                        inset: 0,
                        background: theme.palette.mode === 'dark'
                          ...
                          : 'linear-gradient(180deg, rgba(0,0,0,0.38) 0%, rgba(0,0,0,0.65) 100%)'
                      }}
                    />
                    {/* top overlays */}
                    <Button
                      ...
                      sx={{
                        ...
                        background: theme.palette.mode === 'dark'
                          ...
                          : 'linear-gradient(135deg, #0b5ed7, #0077b6)',
                        border: theme.palette.mode === 'dark'
                          ? '1.2px solid rgba(255,255,255,0.9)'
                          : '1.2px solid rgba(0,0,0,0.55)',
                        boxShadow: '0 8px 18px rgba(0,0,0,0.35)',
                        backdropFilter: 'saturate(140%) blur(2px)',
                        '&:hover': {
                          background: theme.palette.mode === 'dark'
                            ? 'linear-gradient(135deg, #2196f3, #22d3ee)'
                            : 'linear-gradient(135deg, #0a58ca, #00669c)'
                        }
                      }}
                    >
                    ...
                    {/* title overlay */}
                    <Typography variant="h5" sx={{ position: 'absolute', bottom: 12, left: 16, color: 'common.white', fontWeight: 700, textShadow: '0 1px 3px rgba(0,0,0,0.7)' }}>
                  ...
                  <Box
                    sx={{
                      ...
                      alignItems: 'center',
                      gap: 1,
                      color: '#ffffff', // always white text for like badge in both modes
                  ...
                  <CardContent sx={{ flexGrow: 1 }}>
                    <Typography variant="body2" color="text.secondary" sx={{ mb: 2, display: '-webkit-box', WebkitLineClamp: 5, WebkitBoxOrient: 'vertical', overflow: 'hidden', textOverflow: 'ellipsis', wordBreak: 'break-word', hyphens: 'auto' }}>
