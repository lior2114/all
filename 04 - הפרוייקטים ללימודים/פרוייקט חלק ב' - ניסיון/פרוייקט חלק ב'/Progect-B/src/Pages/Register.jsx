    ...
    <Container component="main" maxWidth="sm">
      <Box className={styles.registerContainer}>
        <Paper elevation={3} className={styles.registerPaper}>
          <Typography component="h1" variant="h4" className={styles.registerTitle}>
          ...
          <Box component="form" onSubmit={handleSubmit} className={styles.registerForm}>
            <TextField
              margin="normal"
              required
              fullWidth
              ...
              InputProps={{
                startAdornment: (
                  <InputAdornment position="start">
                    <Person className={styles.inputAdornment} />
                  </InputAdornment>
                ),
              }}
            ...
            <TextField
              ...
              InputProps={{
                startAdornment: (
                  <InputAdornment position="start">
                    <Badge className={styles.inputAdornment} />
                  </InputAdornment>
                ),
              }}
              InputLabelProps={{ shrink: true }}
            ...
            <TextField
              ...
              InputProps={{
                ...
                endAdornment: emailChecking && (
                  <InputAdornment position="end" className={styles.emailChecking}>
