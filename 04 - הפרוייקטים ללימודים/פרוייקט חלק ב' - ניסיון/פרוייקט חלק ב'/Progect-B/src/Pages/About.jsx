  ...
  return (
    <Container maxWidth="lg">
      <Box className={styles.aboutContainer}>
        ...
        {/* Additional Info */}
        <Paper elevation={2} className={styles.additionalInfo}>
          <Typography variant="h5" component="h3" gutterBottom className={styles.additionalTitle}>
            {t('המטרה שלנו', 'Our Goal')}
          </Typography>
          <Typography variant="body1" className={styles.additionalText}>
