...
class Vacations_Model:
    ...
    @staticmethod
    def create_vacation(country_id,vacation_name, vacation_description, vacation_start, vacation_ends, vacation_price, vacation_file_name ):
        with Vacations_Model.get_db_connection() as connection:
            cursor = connection.cursor()
            sql = "insert into vacations (country_id, vacation_name, vacation_description, vacation_start, vacation_ends, vacation_price, vacation_file_name) values (?, ?, ?, ?, ?, ?, ?)"
            cursor.execute(sql,(country_id, vacation_name, vacation_description, vacation_start, vacation_ends, vacation_price, vacation_file_name))
            connection.commit()
    ...
    def get_all_vacations():
        with Vacations_Model.get_db_connection() as connection:
            cursor = connection.cursor()
            sql = '''select vacations.vacation_id, countries.country_name, vacations.vacation_name, vacations.vacation_description, vacations.vacation_start, vacations.vacation_ends, vacations.vacation_price, vacations.vacation_file_name
            from vacations
            ...
            return [
                {
                    ...
                    "country_name":row[1],
                    "vacation_name":row[2],
                    "vacation_description":row[3],
                    "vacation_start":row[4],
                    "vacation_ends":row[5],
                    "vacation_price":row[6],
                    "vacation_file_name":row[7]
                }
    ...
    def show_vacation_by_id(vacation_id):
        with Vacations_Model.get_db_connection() as connection:
            ...
            return {
                    ...
                    "vacation_name":vacation[2],
                    "vacation_description":vacation[3],
                    "vacation_start":vacation[4],
                    "vacation_ends":vacation[5],
                    "vacation_price":vacation[6],
                    "vacation_file_name":vacation[7]
                }
