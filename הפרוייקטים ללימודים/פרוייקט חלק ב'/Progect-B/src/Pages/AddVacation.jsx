        ...
        <Box component="form" onSubmit={onSubmit}>
          <Grid container spacing={2}>
            <Grid item xs={12} sm={6} sx={{ position: 'relative' }}>
              ...
              />
              {panelOpen && (
                <Box id="countries-add-list" role="listbox" aria-label="רשימת מדינות" sx={{ maxHeight: 300, overflowY: 'auto', border: 1, borderColor: 'divider', borderRadius: 1, mt: 1, backgroundColor: 'background.paper', position: 'absolute', zIndex: 10, width: '100%' }}>
                  {worldCountries
                    .filter((c)=> {
